        ...
        <div class = "form-holder">
            ...
            <form action="Register" name="form1" class="needs-validation" onsubmit="return pwd_validation()" novalidate method="post">
                ...
                <div class="row g-2 input-row">
                    ...
                    <div class="col-sm">
                            <div class="form-floating mb-3" >
                                <input name="phone" type = "tel" class = "form-control"  id = "phone" pattern="^(\+91[\-\s]?)?[0]?(91)?[2-9]\d{9}$" required>
                        ...
                        <div class="row g-2 input-row" style="padding-top: 30px;">
                            <div class="col-sm" style="padding-right: 20px;">
                                <div class="form-floating mb-3">
                                    <input name="password1" type = "password" class = "form-control"  id = "password1" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$"  required>
                            ...
                            <div class="col-sm">
                                <div class="form-floating mb-3" >
                                    <input type = "password" class = "form-control"  id = "password2" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,12}$" required>
                        ...
                        <input name="password" type="hidden" name="hide" id="hide" />

                        
                        <div class="col-sm" style="padding: 20px 1px;">
                            <div class="form-floating mb-3" >
                                <button type="submit" class="btn form-submit bamboo" onclick="return encrypt()">Sign up</button>
                            </div>
                        </div>
