...
<body onload="preview()">
    ...
    <div id="header"></div>
       ...
       <form action="EditArticle" class="needs-validation" enctype="multipart/form-data" novalidate method="post">
        ...
        <div class = "form-holder">
            ...
            <br>
				...
				<input type="hidden" name="article_id" value="<% out.println(request.getParameter("article_id")); %>">
